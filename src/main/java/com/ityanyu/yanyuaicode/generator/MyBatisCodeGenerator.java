 ...
 * @package com.ityanyu.yanyuaicode.generator
 * @className com.ityanyu.yanyuaicode.generator.MyBatisCodeGenerator
...
public class MyBatisCodeGenerator {
    ...
    public static GlobalConfig createGlobalConfig() {
        ...
        globalConfig.getPackageConfig()
                .setBasePackage("com.yanyu.yanyuaicode.genresult");
        ...
        globalConfig.getJavadocConfig()
                .setAuthor("<a href=\"https://github.com/yanyu\">烟雨</a>")
                .setSince("");
        return globalConfig;
    }
}
