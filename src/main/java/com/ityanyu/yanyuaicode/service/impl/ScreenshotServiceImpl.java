...
import com.ityanyu.yanyuaicode.manager.CosManager;
import com.ityanyu.yanyuaicode.service.ScreenshotService;
import com.ityanyu.yanyuaicode.utils.WebScreenshotUtils;
...
public class ScreenshotServiceImpl implements ScreenshotService {
    ...
    public String generateAndUploadScreenshot(String webUrl) {
        ...
        ThrowUtils.throwIf(StrUtil.isBlank(localScreenshotPath), ErrorCode.OPERATION_ERROR, "应用封面生成失败");
        try {
            // 2. 上传到对象存储
